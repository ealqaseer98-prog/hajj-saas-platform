...
const EXTRACT_PROMPT =
  'Extract these fields from this passport and return ONLY strict minified JSON, no markdown, no explanation: {"full_name_en":..., "full_name_ar":..., "passport_number":..., "nationality":..., "date_of_birth":"YYYY-MM-DD", "gender":"male"|"female", "expiry_date":"YYYY-MM-DD"}. Read the MRZ (machine-readable zone) if present for accuracy. Use null for any field you cannot determine. For nationality, give the Arabic nationality word if determinable (e.g. بحريني).'
